<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Adminviewnewsbydiv.aspx.cs" Inherits="Adminviewnewsbydiv" %>
        ...
        <tr>
            <td colspan="15">
                ...
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" 
                    Text="View News by Division"></asp:Label>
                &nbsp;</td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td colspan="15">
                &nbsp;&nbsp;<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="newsid" DataSourceID="SqlDataSource2" Width="934px">
                    <Columns>
